...
slug: josh-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/josh-wealth-plan
seo:
  primaryKeyword: debt elimination strategy
  secondaryKeywords:
    - airbnb cohosting income
    - short term rental arbitrage
  longTailKeywords:
    - how to pay off credit card debt with heloc
    - build cash flow with airbnb cohosting
...
tags:
  ...
  - bitcoin
  - cash flow
image: /assets/images/blog/wealth-plan-josh.jpg
imageAlt: "Josh's Personalized Wealth Plan Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, debt elimination, heloc refinancing, credit card payoff, airbnb cohosting, short term rental arbitrage, house hacking, bitcoin accumulation, cash flow strategy, financial turnaround
statistics:
    - label: "Annual Income (1099)"
      value: "$104,400"
      icon: "briefcase"
    - label: "Credit Card Debt to Eliminate"
      value: "$38,000"
      icon: "credit-card"
    - label: "Available Home Equity"
      value: "$180,000"
      icon: "home"
    - label: "Year-One Projected ROI"
      value: "$78,400"
      icon: "trending-up"
    ...
    - label: "Monthly Expense Reduction"
      ...
      icon: "scissors"
faq:
  - question: "How does a HELOC help eliminate high-APR credit card debt?"
    answer: "A Home Equity Line of Credit (HELOC) converts credit card debt from 18-29% APR to 8-10% variable rates. For Josh's $38,000 in credit cards, this saves $7,000-$10,000 in first-year interest alone. The interest-only flexibility allows directing all surplus cash toward principal elimination rather than compound interest payments."
  - question: "Why start with cohosting before arbitrage or house hacking?"
    answer: "Cohosting requires near-zero capital (just software tools under $100/month) and generates immediate credibility with landlords. Earning $300-$800/month per client creates cash flow to fund the $5,000-$7,000 needed for first arbitrage unit deposits and furnishings. This progression minimizes risk while building operational expertise."
  - question: "What is the difference between cohosting, arbitrage, and house hacking?"
    answer: "Cohosting manages properties for owners (20% of gross, no lease risk). Arbitrage rents units long-term and sublets short-term (higher profit, lease obligation). House hacking buys property and rents portions while living there (builds equity, owner financing). Josh's plan sequences all three for graduated risk and capital requirements."
  - question: "How does the Bitcoin 'no cap' accumulation strategy work?"
    answer: "Rather than setting a predetermined portfolio percentage, Josh contributes 30% of free cash flow to Bitcoin DCA indefinitely. As debt pays off and cohosting income grows, monthly contributions scale from $250 to $500-$750 and beyond. Lump sums from tax refunds and interest savings also convert to BTC, creating exponential accumulation without arbitrary limits."
  - question: "What is the 50/30/20 budget system and why implement it immediately?"
    answer: "The 50/30/20 system allocates 50% to needs (housing, minimum debt payments), 30% to wants (dining, entertainment), and 20% to savings/debt acceleration. Using Monarch or YNAB locks these categories, preventing lifestyle creep as income grows. Combined with three-account setup (Bills, Spend, Safety), this creates automated financial discipline."
  - question: "How does business credit building create $25K-$50K in low-interest capital?"
    answer: "The business credit ladder starts with net-30 vendors (Uline, Quill, Shirtsy) that report to business bureaus. After 6-8 trades report, revolving accounts (Amazon, Dell) become available. Within 6-9 months, major business cards (Amex Blue Biz, Chase Ink) offer $25K-$50K limits at 0-8% rates — capital for arbitrage deposits without personal credit impact."
---
...
1. Apply for $50,000-$75,000 HELOC against $180,000 available equity
2. Use line to pay off all $38,000 credit card balances immediately
3. Cut up or freeze physical cards to prevent reaccumulation
4. Maintain one card with $1,000 limit for credit score preservation

**Month 3-6: Aggressive Principal Paydown**
1. Implement $500-$800 monthly expense cuts (detailed below)
2. Redirect all freed cash to HELOC principal (not just interest)
3. Target $2,000-$3,000 monthly principal payments
4. Maintain interest-only discipline on minimum payment obligations

**Month 7-12: Full Elimination and Pivot**
1. Complete HELOC payoff before promotional rates expire
2. Close or convert HELOC to standby status
3. Redirect former debt payments to emergency fund ($5,000 → 3 months expenses)
4. Begin scaling BTC DCA and cohosting investment
...
**Implementation:**
1. Draft accountable plan document (template available)
2. Submit monthly expense reports with receipts
3. LLC reimburses Josh personally (tax-free to him)
4. LLC deducts as business expense
...
**What is Cohosting?**
Managing Airbnb/VRBO properties for owners who lack time or expertise. Josh handles:
...
**Lancaster Market Strategy:**
Josh's local market knowledge as a handyman creates credibility with property owners:
1. **Outreach to 20 property owners** (direct mail, networking, referrals)
2. **Goal**: 4 exploratory calls → 1-2 signed agreements
3. **Value proposition**: "Professional management while you maintain ownership income"
4. **First-client milestone**: 60 days from outreach start
...
Renting a property long-term from a landlord, then subletting it short-term to Airbnb/VRBO guests at a premium. Josh becomes a professional tenant and hospitality operator.
...
Purchasing a property and renting portions while living in one unit. For Josh, this likely means:
...
**Accumulation Tiers:**
1. **Months 1-3**: $250/month DCA (River platform)
2. **After HELOC payoff + cohost client #1**: $500-$750/month
3. **After arbitrage stabilizes**: Add $250-$500/month per profitable unit
4. **Lump sum rule**: 100% of tax refunds, HELOC interest savings, "extra" months → BTC
...
**Sizing**: $25,000-$50,000 allocation after BTC plan is "humming"
**Target income**: $2,000-$4,500/year pre-tax (variable/not guaranteed)
**Key rule**: BTC remains uncapped; income sleeve is sidecar only
