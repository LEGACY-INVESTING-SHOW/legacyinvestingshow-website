...
slug: patricia-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/patricia-wealth-plan
seo:
  primaryKeyword: pre retirement wealth plan
  secondaryKeywords:
    - retirement income optimization
    - tax efficient withdrawals
  longTailKeywords:
    - how to optimize retirement income withdrawals
    - pre retiree tax strategy wealth plan
...
tags:
  ...
  - rmd planning
  - wealth preservation
image: /assets/images/blog/wealth-plan-patricia.jpg
imageAlt: "Patricia's Personalized Wealth Plan Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, pre retirement strategy, retirement income optimization, tax efficient withdrawals, Roth conversions, Social Security timing, RMD planning, retirement tax strategy, wealth preservation
statistics:
    - label: "Life Stage"
      value: "Pre-Retirement"
      icon: "calendar"
    - label: "Focus"
      value: "Income Optimization"
      icon: "trending-up"
    - label: "Tax Priority"
      value: "Efficiency"
      icon: "shield"
...
faq:
  ...
  - question: "How should Social Security timing be coordinated with other income?"
    answer: "Social Security taxation depends on combined income (SS + other income). Patricia's plan evaluates delaying SS until 70 for maximum benefit if other income sources bridge the gap, or claiming earlier if portfolio withdrawals would exceed tax-efficient levels. The coordination goal is minimizing provisional income that triggers SS taxation (up to 85% of benefits taxable)."
  - question: "What is the RMD impact on retirement tax planning?"
    answer: "Required Minimum Distributions starting at age 73 (75 for those born 1960+) force taxable withdrawals from Traditional accounts regardless of need. Patricia's plan reduces pre-RMD balances through strategic Roth conversions and qualified charitable distributions (QCDs), minimizing future forced income that could push into higher brackets."
  - question: "How can pre-retirees optimize healthcare costs before Medicare?"
    answer: "The bridge period (age 60-65) between employer coverage and Medicare requires ACA marketplace navigation. Patricia's plan manages modified adjusted gross income (MAGI) to qualify for premium tax credits, potentially saving $10,000+ annually in premiums. Roth withdrawals don't count toward MAGI, making prior conversions doubly valuable."
  - question: "What is the 'tax valley' and how do you use it?"
    answer: "The 'tax valley' occurs between retirement (when W-2 income ends) and RMD/Social Security age when taxable income sources resume. During this period, marginal tax rates are often lowest. Patricia's plan accelerates Roth conversions, realizes capital gains at 0% rate (if in 12% bracket), and manages other taxable events during this window for lifetime tax minimization."
---
...
**The Opportunity:**
Convert Traditional IRA/401(k) funds to Roth at 10-12% tax rate instead of future 22%+ rate when RMDs begin.
...
**The Opportunity:**
In 2025, taxpayers in the 12% or lower bracket pay **0% federal tax on long-term capital gains**.
...
**Annual Opportunity:**
Each year in the 12% bracket, harvest gains up to bracket ceiling for zero tax cost. This **resets cost basis higher** without taxation, reducing future tax burden.
...
**The Goal:**
Keep modified adjusted gross income (MAGI) in subsidy-eligible range (100%-400% FPL) while meeting living expenses.
...
**The Problem:**
Traditional IRA/401(k) balances grow for decades. At age 73, RMD percentage starts at 3.65% and increases annually (reaching 6% by age 85, 10%+ by age 95).
