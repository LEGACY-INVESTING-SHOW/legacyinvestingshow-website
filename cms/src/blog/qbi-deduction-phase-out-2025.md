---
title: 'QBI Deduction Phase Out 2025: Complete 2026 Guide for Business Owners'
titleTemplate: '%s | Legacy Investing Show'
description: >-
  Understand QBI deduction phase-out rules for 2025 and plan for 2026 with
  thresholds, scenarios, numeric examples, and a practical 30-day action
  checklist.
date: '2026-02-16'
...
canonical: 'https://www.legacyinvestingshow.com/blog/qbi-deduction-phase-out-2025'
seo:
  primaryKeyword: qbi deduction phase out 2025
  secondaryKeywords:
    - Section 199A deduction limits
    - Form 8995 vs 8995-A
    - SSTB phase out rules
  longTailKeywords:
    - how to calculate qbi deduction phase out 2025 for single filer
    - 2025 qbi phase out thresholds married filing jointly
    - form 8995 instructions taxable income before qbi deduction
  searchIntent: informational
  targetSnippet: >-
    For 2025, the QBI deduction phase-out starts at $197,300 for most non-MFJ
    filers and $394,600 for MFJ, based on taxable income before the QBI
    deduction. If you are inside the phase-out band, targeted moves like
    retirement contributions, entity compensation cleanup, and timing
    adjustments can materially improve your deduction before filing in 2026.
tags:
  - qbi deduction phase out 2025
  - tax strategies
  - wealth strategy
  - financial planning
...
schema:
  - type: Article
    headline: 'QBI Deduction Phase Out 2025: Complete 2026 Guide for Business Owners'
    datePublished: '2026-02-16T00:00:00Z'
    dateModified: '2026-02-16T00:00:00Z'
  - type: FAQPage
    mainEntity:
      - question: What is qbi deduction phase out 2025?
        answer: >-
          qbi deduction phase out 2025 is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from qbi deduction phase out 2025?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement qbi deduction phase out 2025?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with qbi deduction phase out 2025?
        answer: >-
...
breadcrumbs:
  ...
  - name: Tax Strategies
    url: /blog
  - name: 'QBI Deduction Phase Out 2025: Complete 2026 Guide for Business Owners'
    url: /blog/qbi-deduction-phase-out-2025
statistics:
  - value: '$197,300'
    label: 2025 threshold for single and most non-MFJ filers
    icon: dollar
    context: >-
      IRS Instructions for Form 8995 (2025) use taxable income before the QBI
      deduction.
  - value: '$394,600'
    label: 2025 threshold for married filing jointly
    icon: dollar
    context: >-
      Crossing this level can trigger phase-out mechanics depending on business
      type.
  - value: 20%
    label: Maximum Section 199A deduction rate
    icon: chart
    context: >-
      The deduction is generally up to 20% of qualified business income, subject
      to limits.
  - value: 30 days
    label: Recommended review cycle before filing
    icon: clock
    context: >-
      A focused month-long review often catches deduction leaks before return
      finalization.
faq:
  - question: What is qbi deduction phase out 2025?
    answer: >-
      qbi deduction phase out 2025 is a practical strategy framework with clear
...
This guide is educational and planning-focused for US readers filing in 2026 on 2025 income. Start with your baseline numbers, then use this framework to prioritize high-impact moves. If you want broader context first, review the [Tax Strategies hub](/topics/tax-strategies) and then return here to run your calculation.
...
1. The deduction is generally up to 20% of qualified business income.
2. It is also capped by a taxable-income-based limit (often summarized as 20% of taxable income minus net capital gains).
3. In the phase-out band, limits tighten differently for SSTBs versus non-SSTBs.
...
1. Identify whether each business is an SSTB.
2. Compute taxable income before QBI deduction.
3. Place that income in one of three bands: below threshold, phase-out range, or above range.
4. Check whether wage/property limits apply for your business type.
5. Run at least two planning scenarios before finalizing returns.
...
1. Pull draft P and L and year-end payroll reports for each business.
2. Separate true QBI items from non-QBI items, including guaranteed payments and investment income.
3. Mark each entity as SSTB or non-SSTB and document why.
4. Compute taxable income before QBI deduction using your draft return.
5. Place each return in below-threshold, phase-out, or above-range category.
6. Run three scenarios: base case, moderate income reduction, and aggressive reduction.
7. For each scenario, estimate deduction delta, tax savings, compliance cost, and cash impact.
8. Choose the scenario with best after-tax and after-cash outcome, not just biggest deduction.
9. Document assumptions and send a one-page summary to your CPA/advisor for confirmation.
10. Re-run numbers once final K-1s and year-end adjustments are complete.

If you need related deduction ideas while building scenarios, review [Best Tax Deductions 2025](/blog/best-tax-deductions-2025) and [Best Tax Deductions for High-Income Earners](/blog/best-tax-deductions-for-high-income-earners).
...
1. Using AGI instead of taxable income before QBI deduction.
2. Misclassifying an SSTB as non-SSTB without support.
3. Ignoring capital gain interaction with overall taxable-income cap.
4. Assuming entity conversion always improves QBI outcomes.
5. Failing to model wage/property limits before making payroll changes.
6. Waiting until filing season when options are narrower.
7. Chasing deduction size while ignoring cash constraints and risk.
...
- [1031 Exchange vs Itemized Deductions](/blog/1031-exchange-vs-itemized-deductions)
- [1031 Exchange vs Standard Deduction](/blog/1031-exchange-vs-standard-deduction)
- [Best Roth Conversion Strategy Calculator](/blog/best-roth-conversion-strategy-calculator)
...
1. What is my taxable income before QBI deduction under the current draft return?
2. Is each of my entities treated as SSTB or non-SSTB, and what is the support?
3. Am I correctly using Form 8995 or Form 8995-A?
4. Which three moves give the highest net savings after fees and cash-flow impact?
5. How do W-2 wages, UBIA, and owner compensation interact in my case?
6. Which deductions reduce taxable income without creating larger downstream tradeoffs?
7. What documentation should I keep for IRS defensibility?
8. If 2026 rules differ from 2025 assumptions, what is my contingency plan?
