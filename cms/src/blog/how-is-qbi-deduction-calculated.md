---
title: 'How Is QBI Deduction Calculated: Complete 2026 Guide for Business Owners'
titleTemplate: '%s | Legacy Investing Show'
description: >-
  Learn how the QBI deduction is calculated in 2026 with formulas, phase-outs,
  worked examples, scenario tables, and a practical action plan for US
  taxpayers.
date: '2026-02-16'
...
canonical: 'https://www.legacyinvestingshow.com/blog/how-is-qbi-deduction-calculated'
seo:
  primaryKeyword: how is qbi deduction calculated
  secondaryKeywords:
    - qualified business income deduction
    - Section 199A deduction
    - Form 8995 vs 8995-A
  longTailKeywords:
    - how is qbi deduction calculated for s corp owners
    - qbi deduction calculation example with phase out
    - 2026 qbi income limits single and married filing jointly
  searchIntent: informational
  targetSnippet: >-
    The QBI deduction is generally the lesser of 20% of qualified business
    income or 20% of taxable income minus net capital gains. Above IRS income
    thresholds, wage/property limits can cap the deduction for non-SSTBs, and
    SSTBs may see a phase-out to zero.
tags:
...
schema:
  - type: Article
    headline: 'How Is QBI Deduction Calculated: Complete 2026 Guide for Business Owners'
    datePublished: '2026-02-16T00:00:00Z'
    dateModified: '2026-02-16T00:00:00Z'
  - type: FAQPage
    mainEntity:
      - question: What is how is qbi deduction calculated?
        answer: >-
          how is qbi deduction calculated is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from how is qbi deduction calculated?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement how is qbi deduction calculated?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with how is qbi deduction calculated?
        answer: >-
...
breadcrumbs:
  ...
  - name: Tax Strategies
    url: /blog
  - name: 'How Is QBI Deduction Calculated: Complete 2026 Guide for Business Owners'
    url: /blog/how-is-qbi-deduction-calculated
statistics:
  - value: 20%
    label: Maximum QBI write-off
    icon: dollar
    context: >-
      Section 199A can allow up to a 20% deduction on qualified business income,
      subject to limits.
  - value: 2 Forms
    label: Calculation pathways
    icon: list
    context: >-
      Most filers use Form 8995 (simplified) or Form 8995-A (complex with
      wage/property and SSTB limits).
  - value: Annual
    label: Income threshold updates
    icon: calendar
    context: >-
      IRS inflation adjustments change threshold and phase-out amounts each tax
      year.
  - value: 3 Core limits
    label: Where deductions get reduced
    icon: chart
    context: >-
      Taxable income cap, W-2/UBIA wage-property limit, and SSTB phase-out can
      all reduce benefits.
faq:
  - question: What is how is qbi deduction calculated?
    answer: >-
...
1. Calculate QBI by business.
2. Compute tentative deduction: 20% x QBI.
3. Compute overall taxable-income cap: 20% x (taxable income - net capital gain).
4. If taxable income is above IRS thresholds, apply wage/property limits (for non-SSTBs) and phase-out rules (especially for SSTBs).
5. Final deduction is generally the lower applicable amount after these limits.
...
If you are mapping this against other write-off opportunities, review [Best Tax Deductions 2025](/blog/best-tax-deductions-2025) and [Best Tax Deductions for High-Income Earners](/blog/best-tax-deductions-for-high-income-earners).
...
1. Pull last-year return and current-year YTD P&L.
2. Separate likely QBI items from non-QBI items (wages, guaranteed payments, investment income).
3. Estimate taxable income before QBI deduction.
4. Classify each business as SSTB or non-SSTB.
5. Run a base-case QBI estimate with Form 8995 logic.
6. If near or above thresholds, run Form 8995-A style modeling with wage/property limits.
7. Build 3 scenarios: conservative, expected, aggressive income case.
8. Stress-test year-end moves: retirement contributions, income timing, wage adjustments, equipment timing.
9. Choose a target action set by mid-quarter and document assumptions.
10. Recalculate in final 30 days of the tax year and lock decisions with your CPA.
...
1. Treating all business profit as QBI.
Reason: Some items are excluded by definition.
Impact: Overstated deduction and amended return risk.

2. Ignoring net capital gains in the taxable-income cap.
Reason: Owners focus only on business books.
Impact: Claimed deduction can be materially overstated.

3. Missing SSTB classification nuance.
Reason: Service businesses assume they are always in or always out.
Impact: Bad planning around phase-out years.

4. Assuming entity change automatically helps.
Reason: S corp election is treated as universal tax optimization.
Impact: Higher compliance cost without net tax gain.

5. Not modeling wage/property limits above threshold.
Reason: Owners use only quick calculators.
Impact: Large gap between estimate and filed result.

6. Running the analysis once, too early.
Reason: Income shifts late in year.
Impact: Missed execution window for tax moves.
...
For deeper comparisons, browse [our tax article library](/blog).
...
1. Based on my projected taxable income, am I below threshold, in phase-out, or above it this year?
2. Which items in my return are excluded from QBI and why?
3. Should we file on Form 8995 or 8995-A given my facts?
4. For my entity, what compensation level balances payroll compliance and QBI impact?
5. If I am an SSTB, what realistic actions could improve results without aggressive positions?
6. How do capital gains this year affect my taxable-income cap?
7. Which three year-end moves could change my deduction the most?
8. What documentation should I keep now to support this deduction on audit?
