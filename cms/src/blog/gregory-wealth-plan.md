...
slug: gregory-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/gregory-wealth-plan
seo:
  primaryKeyword: business owner wealth plan
  secondaryKeywords:
    - multi entity structure
    - profit distribution strategy
  longTailKeywords:
    - business owner tax optimization strategy
    - entity structure for wealth building
...
disclaimer: true
keywords:
  - wealth plan, business owner strategy, entity optimization, s-corp, profit distribution, multi-entity structure, owner compensation, business tax strategy
statistics:
    - label: "Business Type"
      value: "Operating Company"
      icon: "briefcase"
    - label: "Entity Focus"
      value: "Multi-Structure"
      icon: "layers"
...
*Social Security cap ($160,200 in 2025) limits additional SE tax above this level
**Maximum payroll tax savings achieved at Social Security wage base
