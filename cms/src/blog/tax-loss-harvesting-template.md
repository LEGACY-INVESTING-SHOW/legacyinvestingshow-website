---
title: 'tax loss harvesting template: Practical Guide + Examples for US Investors'
titleTemplate: '%s | Legacy Investing Show'
description: >-
  Use this tax loss harvesting template to decide when to harvest, avoid wash
  sales, and improve after-tax returns with concrete rules, examples, and a
  30-day checklist.
date: '2026-02-16'
...
category: Investing
canonical: 'https://www.legacyinvestingshow.com/blog/tax-loss-harvesting-template'
seo:
  primaryKeyword: tax loss harvesting template
  secondaryKeywords:
    - tax loss harvesting strategy
    - wash sale rule
    - capital gains tax planning
  longTailKeywords:
    - best tax loss harvesting template for taxable brokerage accounts
    - how to avoid wash sale while harvesting losses
    - tax loss harvesting example with short-term and long-term gains
  searchIntent: commercial
  targetSnippet: >-
    This tax loss harvesting template gives US investors a repeatable system to
    offset gains, reduce taxes, and avoid wash-sale errors. Use the scenario
    table, numeric example, and 30-day checklist to decide when to harvest, when
    to wait, and how to document each trade.
tags:
...
schema:
  - type: Article
    headline: 'tax loss harvesting template: Practical Guide + Examples for US Investors'
    datePublished: '2026-02-16T00:00:00Z'
    dateModified: '2026-02-16T00:00:00Z'
  - type: FAQPage
    mainEntity:
      - question: What is tax loss harvesting template?
        answer: >-
          tax loss harvesting template is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from tax loss harvesting template?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement tax loss harvesting template?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with tax loss harvesting template?
        answer: >-
...
breadcrumbs:
  ...
  - name: Investing
    url: /blog
  - name: 'tax loss harvesting template: Practical Guide + Examples for US Investors'
    url: /blog/tax-loss-harvesting-template
statistics:
  - value: '$3,000'
    label: Annual ordinary income offset limit
    icon: dollar
    context: >-
      Federal rules generally allow up to $3,000 of net capital losses to offset
      ordinary income each year, with additional losses carried forward.
  - value: 30 days
    label: Wash-sale window
    icon: calendar
    context: >-
      Buying the same or substantially identical security within 30 days before
      or after a loss sale may defer the loss deduction.
  - value: 1%-2% per year
    label: Potential long-run tax alpha
    icon: chart
    context: >-
      J.P. Morgan Private Bank analysis discusses roughly 1%-2% potential annual
      tax savings over 10 years in certain conditions.
  - value: Year-round
    label: Monitoring cadence
    icon: clock
    context: >-
      Fidelity and Morgan Stanley both frame tax-loss harvesting as an ongoing
      process, not just a year-end move.
faq:
  - question: What is tax loss harvesting template?
    answer: >-
      tax loss harvesting template is a practical strategy framework with clear
...
If you want additional implementation ideas, review more examples in the [blog library](/blog) and compare with broader portfolio planning in [best asset allocation for retirement](/blog/best-asset-allocation-for-retirement).
