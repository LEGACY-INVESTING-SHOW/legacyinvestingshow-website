---
title: 'qbi deduction income limits: Complete 2026 Guide for Pass-Through Owners'
titleTemplate: '%s | Legacy Investing Show'
description: >-
  Detailed 2026 guide to qbi deduction income limits with thresholds, SSTB
  rules, wage and UBIA math, a worked example, scenario table, and a 30-day
  action plan.
date: '2026-02-16'
...
canonical: 'https://www.legacyinvestingshow.com/blog/qbi-deduction-income-limits'
seo:
  primaryKeyword: qbi deduction income limits
  secondaryKeywords:
    - Section 199A deduction
    - SSTB phaseout rules
    - W-2 wage and UBIA limitation
  longTailKeywords:
    - how to calculate qbi deduction income limits for 2026
    - qbi deduction income limits for s corp owners
    - qbi deduction income limits single vs married filing jointly
  searchIntent: informational
  targetSnippet: >-
    The QBI deduction can be worth up to 20% of qualified business income, but
    income thresholds, SSTB phaseouts, and wage/property caps determine what you
    actually keep. Use 2025 threshold benchmarks as planning anchors, then
    confirm final 2026 IRS limits before filing.
tags:
...
schema:
  - type: Article
    headline: 'qbi deduction income limits: Complete 2026 Guide for Pass-Through Owners'
    datePublished: '2026-02-16T00:00:00Z'
    dateModified: '2026-02-16T00:00:00Z'
  - type: FAQPage
    mainEntity:
      - question: What is qbi deduction income limits?
        answer: >-
          qbi deduction income limits is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from qbi deduction income limits?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement qbi deduction income limits?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with qbi deduction income limits?
        answer: >-
...
breadcrumbs:
  ...
  - name: Tax Strategies
    url: /blog
  - name: 'qbi deduction income limits: Complete 2026 Guide for Pass-Through Owners'
    url: /blog/qbi-deduction-income-limits
statistics:
  - value: 20%
    label: Maximum Section 199A rate
    icon: dollar
    context: >-
      The deduction is generally up to 20% of qualified business income before
      other caps apply.
  - value: '$197,300 / $394,600'
    label: 2025 threshold baseline (Single / MFJ)
    icon: calendar
    context: >-
      Commonly cited 2025 taxable-income thresholds where limitations begin;
      2026 values are inflation-adjusted by the IRS.
  - value: '$50,000 / $100,000'
    label: Typical phaseout band (Single / MFJ)
    icon: chart
    context: >-
      For many taxpayers, wage limits and SSTB phaseouts ramp in over these
      ranges above the threshold.
  - value: Form 8995 or 8995-A
    label: Primary reporting forms
    icon: list
    context: >-
      Simple situations may use Form 8995, while more complex or high-income
      cases often require Form 8995-A.
faq:
  - question: What is qbi deduction income limits?
    answer: >-
      qbi deduction income limits is a practical strategy framework with clear
...
If you want related planning context, start with the [Tax Strategies hub](/topics/tax-strategies) and the broader [blog library](/blog).
...
1. Estimate taxable income before QBI deduction.
2. Separate each trade or business and compute preliminary QBI per activity.
3. Classify each activity as SSTB or non-SSTB with your advisor.
4. Pull W-2 wage totals and UBIA by business, not just consolidated books.
5. Calculate tentative QBI deduction at 20% for each business.
6. Apply wage/property limitation where applicable: greater of 50% of W-2 wages, or 25% of W-2 wages plus 2.5% of UBIA.
7. Apply SSTB phaseout adjustments if income is in or above the phaseout range.
8. Apply overall taxable-income cap at 20% of taxable income minus net capital gain.
9. Compare planning levers: retirement contributions, wage design, equipment timing, and entity compensation policy.
10. Document assumptions so your CPA can validate quickly on Form 8995 or 8995-A.
...
1. Using gross revenue instead of QBI net income. This inflates expectations and breaks planning decisions.
2. Ignoring the taxable-income cap. You can have high QBI and still have a lower allowed deduction.
3. Treating all businesses as one bucket without checking aggregation rules.
4. Paying owner wages too low in high-income non-SSTB businesses, which can choke the wage limitation.
5. Assuming SSTB owners always get zero. Many still get partial deductions in the phaseout band.
6. Forgetting capital gains interaction. Large portfolio gains can reduce the taxable-income-based cap.
7. Waiting until filing season. By then payroll, contribution, and timing levers are mostly gone.
8. Making entity changes for tax optics only, without modeling legal, payroll, admin, and audit complexity costs.
...
If you want adjacent tactics, review [best tax deductions for high-income earners](/blog/best-tax-deductions-for-high-income-earners), [best tax deductions for individuals](/blog/best-tax-deductions-for-individuals), and [1031 exchange vs standard deduction](/blog/1031-exchange-vs-standard-deduction).
