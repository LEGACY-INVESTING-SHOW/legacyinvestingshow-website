...
const internalLinks = [
  // Core strategies
  ['1031 exchange', '1031 exchange', '/tax-strategies/1031-exchange.html', 'high'],
  ['1031 Exchange', '1031 Exchange', '/tax-strategies/1031-exchange.html', 'high'],
  ['cost segregation', 'cost segregation study', '/tax-strategies/cost-segregation.html', 'high'],
  ['Cost Segregation', 'Cost Segregation', '/tax-strategies/cost-segregation.html', 'high'],
  ['bonus depreciation', 'bonus depreciation', '/tax-strategies/bonus-depreciation.html', 'high'],
  ['Bonus Depreciation', 'Bonus Depreciation', '/tax-strategies/bonus-depreciation.html', 'high'],
  ['short-term rental loophole', 'short-term rental loophole', '/tax-strategies/short-term-rental-loophole.html', 'high'],
  ['Short-Term Rental Loophole', 'Short-Term Rental Loophole', '/tax-strategies/short-term-rental-loophole.html', 'high'],
  ['real estate professional status', 'real estate professional status', '/tax-strategies/real-estate-professional-status.html', 'high'],
  ['Real Estate Professional Status', 'Real Estate Professional Status', '/tax-strategies/real-estate-professional-status.html', 'high'],
  ['opportunity zones', 'Opportunity Zones', '/tax-strategies/opportunity-zones.html', 'high'],
  ['Opportunity Zones', 'Opportunity Zones', '/tax-strategies/opportunity-zones.html', 'high'],
  
  // Retirement accounts
  ['solo 401k', 'Solo 401k', '/tax-strategies/solo-401k.html', 'medium'],
  ['Solo 401k', 'Solo 401k', '/tax-strategies/solo-401k.html', 'medium'],
  ['self-directed IRA', 'Self-Directed IRA', '/tax-strategies/self-directed-ira.html', 'medium'],
  ['SEP IRA', 'SEP IRA', '/retirement/sep-ira-guide.html', 'medium'],
  ['Roth conversion', 'Roth conversion ladder', '/tax-strategies/roth-conversion-ladder.html', 'medium'],
  
  // Other strategies
  ['depreciation', 'rental property depreciation', '/tax-strategies/rental-property-depreciation.html', 'medium'],
  ['Augusta Rule', 'Augusta Rule', '/tax-strategies/augusta-rule.html', 'medium'],
  ['HSA', 'Health Savings Account strategy', '/tax-strategies/hsa-strategy.html', 'medium'],
  ['S-Corp', 'S-Corporation strategy', '/tax-strategies/s-corp-strategy.html', 'medium'],
];
