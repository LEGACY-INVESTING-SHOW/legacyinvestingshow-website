The user wants me to write a blog post about Airbnb guest message templates. Let me analyze the requirements:

1. Working title: Airbnb Guest Message Templates That Reduce Friction and Improve Reviews
2. Primary keyword: airbnb messages
3. Audience: Hosts who want better communication without sounding robotic
4. Goal: Attract operators who care about systems and guest experience
5. Angle: Template-driven communication system for pre-booking through checkout
6. Notes: Include example messages, timing guidance, and how to keep templates human. Do not overpromise review outcomes.

I need to write a complete, publish-ready blog post in markdown. Based on the AGENTS.md instructions, I should:
...
- Use the target keyword naturally rather than stuffing it
- If facts are uncertain, state general guidance instead of making up specifics
- The blog post should be saved to content/blog/ directory

Let me write a comprehensive blog post following the legacy-blog-writer skill guidelines. I need to make this practical, actionable, and authentic - not overpromising while still being valuable.

The structure should follow:
- H1 Title
- Introduction (hook, context, preview)
- H2 sections covering the message journey
- Practical examples with message templates
- Timing guidance
- How to humanize templates
- Conclusion with CTA

Let me write this in markdown format.
...
>
> **📍 Getting there:**
> [Address or directions from nearest major landmark/transit]
>
> **🚪 How to enter:**
> [Specific instructions: key code, lockbox location, or "I'll meet you at the door"]
>
> **🅿️ Parking:**
> [Parking details—if complex, consider a photo or short video]
>
> **🏠 What's in the unit:**
> [Brief mention of any guest-specific amenities: "I've set up the pullout couch for you, and extra blankets are in the closet"]
>
> **⚠️ One thing to know:**
> [Any property-specific quirks: "The hallway can be tricky to find—look for the blue door on the right"]
>
