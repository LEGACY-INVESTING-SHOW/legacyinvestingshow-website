...
description: "A transcript-based breakdown of the 7 money moves from Preston's video, including liquidity, mega backdoor Roth, S-Corp thresholds, cost segregation, debt strategy, and asset protection."
date: "2026-03-02"
...
canonical: "https://legacyinvestingshow.com/blog/money-moves-cpa-never-mentioned-high-earners"
...
seo:
  ...
  targetSnippet: "If you earn $200K+, the usual checklist is not enough. This guide covers 7 transcript-based moves: liquidity, retirement stacking, tax structure, real estate deductions, debt strategy, taxable investing, and protection."
...
faq:
  - question: "Why is maxing a 401k and HSA not enough for $200K+ earners?"
    answer: "In the transcript, Preston explains that this baseline advice is not wrong, but incomplete. At higher incomes, taxes are often one of the largest annual expenses. Higher earners need an added layer of entity structure, deduction planning, debt strategy, and protection planning to meaningfully change outcomes."
  - question: "How much liquidity should high earners hold?"
    answer: "The video recommends treating liquidity as foundational. Instead of defaulting to three months, many high earners may need closer to six months because fixed expenses are higher and harder to cut quickly. The goal is resilience, then moving capital toward higher-impact strategies."
  - question: "When does an S-Corp election usually start to make sense?"
    answer: "The transcript gives a practical range: often around $60K to $80K of net business profit. Below that, admin and payroll costs can reduce the benefit. Above that range, splitting salary and distributions can create recurring self-employment tax savings if implemented correctly."
  - question: "What did the cost segregation example show?"
    answer: "The video example used a $600K rental property. Standard depreciation was around $17K per year. With cost segregation and bonus depreciation, year-one depreciation rose to roughly $65K, with first-year tax savings over $16K at that client's bracket."
  - question: "How should high earners think about debt versus investing?"
    answer: "Preston's framework in the transcript is to aggressively eliminate very high-interest debt, carry low-interest and tax-favored debt strategically, and evaluate mid-range debt based on available return opportunities and risk tolerance."
  - question: "Why does protection planning matter in a wealth plan?"
    answer: "Because growing net worth increases legal and liability exposure. The transcript emphasizes low-cost umbrella insurance and appropriately sized term life insurance as basic protection layers, especially once assets and income are significant."
