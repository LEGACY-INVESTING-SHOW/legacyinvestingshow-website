---
title: 7 Money Moves Your CPA Never Mentioned for $200K+ Earners
titleTemplate: '%s | Legacy Investing Show'
description: >-
  A transcript-based breakdown of the 7 money moves from Preston's video,
  including liquidity, mega backdoor Roth, S-Corp thresholds, cost segregation,
  debt strategy, and asset protection.
date: '2026-03-02'
...
canonical: >-
  https://www.legacyinvestingshow.com/blog/money-moves-cpa-never-mentioned-high-earners
seo:
  primaryKeyword: money moves for high income earners
  secondaryKeywords:
    - tax strategies for 200k earners
    - cpa tax planning gaps
    - mega backdoor roth strategy
    - s corp tax savings
    - cost segregation tax strategy
    - high earner wealth plan
    - umbrella insurance high earners
  longTailKeywords:
    - what to do after maxing 401k and hsa
    - best tax strategies for 300k income
    - how high earners reduce taxes legally
    - when does s corp election make sense
    - how much emergency fund for high earners
    - cost segregation first year tax savings
    - debt strategy for high income professionals
    - how to use heloc strategically
    - tax efficient taxable brokerage strategy
    - asset protection checklist for high earners
  searchIntent: informational
  targetSnippet: >-
    If you earn $200K+, the usual checklist is not enough. This guide covers 7
    transcript-based moves: liquidity, retirement stacking, tax structure, real
    estate deductions, debt strategy, taxable investing, and protection.
lsiKeywords:
...
tags:
  ...
  - cash flow
  - financial planning
image: 'https://i.ytimg.com/vi/azUMK0CKN58/maxresdefault.jpg'
imageAlt: 7 money moves for high income earners from Preston Seo
imageWidth: 1200
imageHeight: 630
twitterCard: summary_large_image
featured: false
youtubeId: azUMK0CKN58
videoDuration: PT9M59S
schema:
  type: BlogPosting
...
tocDepth: 3
faq:
  - question: Why is maxing a 401k and HSA not enough for $200K+ earners?
    answer: >-
      In the transcript, Preston explains that this baseline advice is not
      wrong, but incomplete. At higher incomes, taxes are often one of the
      largest annual expenses. Higher earners need an added layer of entity
      structure, deduction planning, debt strategy, and protection planning to
      meaningfully change outcomes.
  - question: How much liquidity should high earners hold?
    answer: >-
      The video recommends treating liquidity as foundational. Instead of
      defaulting to three months, many high earners may need closer to six
      months because fixed expenses are higher and harder to cut quickly. The
      goal is resilience, then moving capital toward higher-impact strategies.
  - question: When does an S-Corp election usually start to make sense?
    answer: >-
      The transcript gives a practical range: often around $60K to $80K of net
      business profit. Below that, admin and payroll costs can reduce the
      benefit. Above that range, splitting salary and distributions can create
      recurring self-employment tax savings if implemented correctly.
  - question: What did the cost segregation example show?
    answer: >-
      The video example used a $600K rental property. Standard depreciation was
      around $17K per year. With cost segregation and bonus depreciation,
      year-one depreciation rose to roughly $65K, with first-year tax savings
      over $16K at that client's bracket.
  - question: How should high earners think about debt versus investing?
    answer: >-
      Preston's framework in the transcript is to aggressively eliminate very
      high-interest debt, carry low-interest and tax-favored debt strategically,
      and evaluate mid-range debt based on available return opportunities and
      risk tolerance.
  - question: Why does protection planning matter in a wealth plan?
    answer: >-
      Because growing net worth increases legal and liability exposure. The
      transcript emphasizes low-cost umbrella insurance and appropriately sized
...
relatedPosts:
  ...
  - slug: 88k-tax-savings-cpa-missed-case-study
    title: '$88K Tax Savings Case Study: What One CPA Missed'
wordCount: '1597'
...
<div class="video-embed my-8">
  <iframe width="100%" height="415" src="https://www.youtube.com/embed/azUMK0CKN58" title="7 Money Moves Your CPA Never Mentioned ($200K+ Earners)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen loading="lazy"></iframe>
</div>

<p><em><a href="https://www.youtube.com/watch?v=azUMK0CKN58" target="_blank" rel="noopener">Watch on YouTube</a></em></p>

## Move 1: Fix Liquidity Before Chasing Optimization
...
You can model how different compensation and withholding choices change take-home pay with the [payroll withholding estimator](/tools/payroll-withholding-estimate).
...
- Understand holding periods for long-term gains treatment, and estimate the tax on any planned sale with the [capital gains tax estimator](/tools/capital-gains-tax-estimate).
...
- [Why $150K/Year Feels Broke: The Tax Math Nobody Shows You](/blog/why-150k-year-feels-broke)
- [How to Build $10 Million in 10 Years](/blog/build-10-million-10-years)
- [Latest blog resources](/blog/)
