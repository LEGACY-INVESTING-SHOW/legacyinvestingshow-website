...
description: >-
  A tax loss harvesting checklist with a go or no-go screen, wash-sale
  guardrails, a worked $15,000 loss example, and a 30-day plan for US taxable
  investors.
date: '2026-02-16'
...
category: Investing
canonical: 'https://www.legacyinvestingshow.com/blog/tax-loss-harvesting-checklist'
seo:
  primaryKeyword: tax loss harvesting checklist
  secondaryKeywords:
    - tax-loss harvesting strategy
    - wash sale rule
    - capital loss carryforward
  longTailKeywords:
    - how to do tax loss harvesting without triggering wash sale
    - tax loss harvesting checklist for ETF investors
    - capital losses offset ordinary income 3000 limit
  searchIntent: informational
  targetSnippet: >-
    Use this tax loss harvesting checklist to decide when harvesting is worth
    it, avoid wash-sale mistakes, and execute a 30-day plan that coordinates
    gains, losses, replacement assets, and CPA questions.
tags:
...
schema:
  - type: Article
    headline: >-
      Tax Loss Harvesting Checklist: Practical Guide, Numbers, and a 30-Day
      Action Plan
    datePublished: '2026-02-16T00:00:00Z'
    dateModified: '2026-02-16T00:00:00Z'
  - type: FAQPage
    mainEntity:
      - question: What is tax loss harvesting checklist?
        answer: >-
          tax loss harvesting checklist is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from tax loss harvesting checklist?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement tax loss harvesting checklist?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with tax loss harvesting checklist?
        answer: >-
...
breadcrumbs:
  ...
  - name: >-
      Tax Loss Harvesting Checklist: Practical Guide, Numbers, and a 30-Day
      Action Plan
    url: /blog/tax-loss-harvesting-checklist
statistics:
  - value: '$3,000'
    label: Annual federal ordinary-income offset limit
    icon: dollar
    context: >-
      After netting capital gains and losses, up to $3,000 of excess net capital
      loss can generally reduce ordinary income each tax year.
  - value: 30 days
    label: Wash-sale lookback and lookforward
    icon: calendar
    context: >-
      A wash sale is generally triggered if you buy a substantially identical
      security within 30 days before or after the loss sale date.
  - value: 61-day window
    label: Total wash-sale risk period
    icon: clock
    context: >-
      The full risk window is the sale day plus 30 days before and 30 days
      after.
  - value: Unlimited years
    label: Federal capital-loss carryforward
    icon: chart
    context: >-
      Unused net capital losses can typically carry forward to future years
      until used, subject to annual ordering rules.
faq:
  - question: When is tax-loss harvesting worth doing?
    answer: >-
      When you have realized gains this year or expect them soon, hold taxable
      positions with meaningful unrealized losses, can buy a similar but not
      substantially identical replacement, and can avoid wash sales across
      every household account. Score the five factors 0 to 2 each; 8 to 10 is
      a strong candidate.
  - question: How much tax can harvesting a loss save?
    answer: >-
      In the worked example, a $15,000 harvested loss offset $12,000 of
      long-term gains at 15% ($1,800) and $3,000 of ordinary income at 24%
      ($720), for $2,520 of federal tax saved against about $120 of trading
      friction.
  - question: What triggers a wash sale?
    answer: >-
      Buying a substantially identical security within 30 days before or after
      the loss sale, a 61-day window. Spouse accounts, IRAs, and automatic
      dividend reinvestment can all trigger it, so pause reinvestment and
      check recurring purchases first.
  - question: When should I skip harvesting?
    answer: >-
      When most assets are in tax-deferred or Roth accounts, you are in a
      temporarily low bracket, you already carry large carryforwards with no
      near-term gains, replacements would cause major style drift, or you
      cannot monitor all accounts for accidental repurchases.
toc: true
tocDepth: 3
relatedPosts:
...
If you want to connect this strategy to broader portfolio design, review [asset allocation and tax implications](/blog/asset-allocation-tax-implications), [asset allocation strategies](/blog/asset-allocation-strategies), and the broader [investing hub](/topics/investing).
...
- Harvesting is a tactical layer, not a substitute for allocation discipline.
- Pair it with strategic allocation design and periodic rebalancing.
- For broader tax-aware investing ideas, review [alternative investments guide](/blog/alternative-investments-guide) and [dividend growth investing](/blog/dividend-growth-investing).
