...
description: >-
  Use a capital gains tax template to model stock, real estate, and
  business-sale taxes with NIIT, state tax, and depreciation recapture before
  deciding to sell.
date: '2026-02-16'
...
canonical: 'https://www.legacyinvestingshow.com/blog/capital-gains-tax-template'
seo:
  primaryKeyword: capital gains tax template
  secondaryKeywords:
    - capital gains tax planning
    - Schedule D worksheet
    - cost basis tracking
  longTailKeywords:
    - capital gains tax template for rental property sale
    - how to estimate capital gains tax before selling stock
    - Schedule D capital gains planning checklist for high income earners
  searchIntent: commercial
  targetSnippet: >-
    A capital gains tax template helps you decide whether to sell now, stage
    sales, harvest losses, or defer gains. This guide shows the exact inputs, a
    worked numeric example, a 30-day checklist, and CPA questions so you can
    make practical decisions before year-end.
tags:
  - capital gains tax template
  - tax strategies
  - wealth strategy
  - financial planning
...
schema:
  ...
  - type: FAQPage
    mainEntity:
      - question: What is capital gains tax template?
        answer: >-
          capital gains tax template is a practical strategy framework with
          clear rules, milestones, and risk controls.
      - question: Who benefits from capital gains tax template?
        answer: >-
          People with defined goals and consistent review habits usually benefit
          most.
      - question: How fast can I implement capital gains tax template?
        answer: A workable first version is often possible in 2 to 6 weeks.
      - question: What mistakes are common with capital gains tax template?
        answer: >-
...
breadcrumbs:
  ...
  - name: >-
      Capital Gains Tax Template: Practical Guide + Examples for Better Sell
      Decisions
    url: /blog/capital-gains-tax-template
statistics:
  - value: 3.8%
    label: Net Investment Income Tax
    icon: dollar
    context: >-
      Higher-income filers may owe NIIT on top of capital gains rates, which
      materially changes sell timing decisions.
  - value: Up to 25%
    label: Depreciation recapture rate
    icon: chart
    context: >-
      Unrecaptured Section 1250 gain on real estate can face a higher federal
      rate than long-term capital gains.
  - value: '$3,000'
    label: Annual ordinary-income offset
    icon: list
    context: >-
      Net capital losses generally offset ordinary income up to $3,000 per year,
      with excess carried forward.
  - value: Form 8949 + Schedule D
    label: Core reporting stack
    icon: calendar
    context: >-
      The IRS uses Form 8949 detail and Schedule D summary for most capital
      asset sales and exchanges.
faq:
  - question: What inputs does a capital gains tax template need?
    answer: >-
      For securities: acquisition and sale dates, lot-level cost basis,
      holding period, expected proceeds and fees, loss carryforwards, and
      gains already realized this year. For real estate: purchase price, land
      vs building split, improvements by year, depreciation claimed, selling
      costs, and state jurisdiction. Then add assumptions for federal rates,
      NIIT, and state tax.
  - question: Why can a rental sale be taxed more than a stock sale with the same gain?
    answer: >-
      Depreciation recapture. In the worked example, a $180,000 stock gain
      modeled at about 23.2% effective tax, while the same gain on a rental
      with $60,000 of unrecaptured Section 1250 gain taxed at up to 25% came
      to about 26.5%.
  - question: How does tax-loss harvesting change the template result?
    answer: >-
      Realizing $30,000 of long-term losses in the same year cut the modeled
      tax in the stock example from $41,700 to $34,560, because it lowered
      both the gain and the NIIT base. The tradeoff is portfolio drift and
      wash-sale discipline.
  - question: Where does the template map to my tax return?
    answer: >-
      Sales are reported on Form 8949 and summarized on Schedule D. Structure
      the template around those categories, keep lot records, and pre-fund
      estimated payments so the sale does not create a cash-flow surprise.
toc: true
tocDepth: 3
relatedPosts:
...
For broader planning context, see the [Tax Strategies topic hub](/topics/tax-strategies) and recent [tax strategy articles](/blog).
...
If you are also evaluating deduction strategies, these may help: [Best Tax Deductions for High-Income Earners](/blog/best-tax-deductions-for-high-income-earners) and [Best Tax Deductions 2025](/blog/best-tax-deductions-2025).
...
For investors evaluating real estate deferral paths, compare strategy context in [1031 exchange vs standard deduction](/blog/1031-exchange-vs-standard-deduction) and [1031 exchange vs itemized deductions](/blog/1031-exchange-vs-itemized-deductions).
...
Set target sale month, acceptable tax range, and required net cash.

2. Build a one-page assumptions sheet.
List filing status, income estimate, state exposure, NIIT assumption, and expected bracket conditions.

3. Build lot-level or asset-level basis detail.
For securities, export lots. For real estate, reconstruct adjusted basis with improvements and depreciation.

4. Model at least three sale paths.
Use a baseline case, a staggered-timing case, and an offset case (loss harvesting or defer structure).

5. Add cash-flow planning.
Estimate quarterly payment impact and liquidity reserves needed.

6. Stress-test for errors.
Run a conservative case with a higher effective rate and lower proceeds.

7. Review with CPA before execution.
Send template plus backup records 2 to 4 weeks before planned close.

8. Document post-sale actions.
Capture records needed for Form 8949, Schedule D, and estimated payment follow-through.
...
- Ignoring NIIT in pre-sale modeling.
A plan that looks efficient at capital gain rates alone may be materially worse once NIIT is layered in.

- Using incomplete basis records.
Missing reinvestment history, spin-offs, or real estate improvements can overstate taxable gain.

- Treating real estate gain as one tax bucket.
Recapture vs LTCG split is essential for realistic modeling.

- Forgetting state tax and residency complexity.
State exposure can change the decision even when federal estimates look acceptable.

- Delaying estimated payments.
Cash-flow pain often comes from timing, not total tax alone.

- Waiting until after filing to clean up mistakes.
The IRS amended return process exists for corrections when income, deductions, credits, or other return items change, but fixing later usually costs more time and attention than planning earlier.
