...
slug: dan-kovacich-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/dan-kovacich-wealth-plan
seo:
  primaryKeyword: short term rental keep vs sell analysis
  secondaryKeywords:
    - cost segregation tax benefits
    - multi entity tax structure
  longTailKeywords:
    - how to decide keep or sell rental property
    - cost segregation study benefits 2025
...
tags:
  ...
  - tax optimization
  - Bitcoin strategy
image: /assets/images/blog/wealth-plan-dan-kovacich.jpg
imageAlt: "Dan's Keep vs Sell STR Decision Gate Wealth Plan - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, short term rental strategy, keep vs sell analysis, decision gate framework, cost segregation, bonus depreciation, multi entity structure, tax optimization, Bitcoin DCA, AccuFooting, Caliber Energy
statistics:
...
1. **Strict Decision Gate Framework:** Objective criteria for the keep vs sell decision
2. **Multi-Entity Structure:** Three LLCs for liability isolation and tax optimization
3. **Comprehensive Tax Stack:** 12+ strategies combining for $26,500-$61,000 in tax value
4. **Strategic Investment Deployment:** Bitcoin primary, IREN satellite, income sleeve
5. **Operational Excellence:** Systems, documentation, and professional coordination
...
1. **W-2 Withholding Optimization:** Right-size refunds, tilt 401(k) toward pre-tax for immediate cash relief—$3,000-$6,000 value
2. **Backdoor Roth IRA:** $7,000 non-deductible Traditional IRA contribution with immediate conversion

**Business Level Strategies:**
3. **Accountable Plan Reimbursements:** Business reimburses phone, internet, mileage, home office—$3,000-$6,000 value
4. **Home Office Deduction:** Actual vs simplified method comparison, higher value selected—$2,000-$3,000 value
5. **Augusta Rule (Section 280A):** 12-14 tax-free rental days to businesses with proper documentation—$3,500-$5,000 value
6. **Startup & Organizational Costs (Sec. 195/248):** First-year business formation expense deduction—$1,000-$2,000 value
7. **Tangible Property Optimization:** De minimis ≤$2,500/invoice, 12-month rule for prepaids—$1,000-$2,000 value
8. **Vehicle & Travel Deductions:** Mileage tracking, 50% meals, contemporaneous logs—$1,000-$2,000 value
9. **Schedule C Deductions:** Professional development, software, marketing, supplies—$3,000-$8,000 value
10. **QBI (Section 199A):** 20% deduction on qualified business income below phase-outs—$4,000-$12,000 value
11. **Retirement on LLC Profit:** Solo 401(k) employer contributions or SEP-IRA—$5,000-$15,000 value
12. **Cost Segregation + 100% Bonus Depreciation (Path A only):** Accelerated depreciation creating $45,000-$140,000 in additional tax value
...
- Assumes the building is acquired after January 19, 2025 and placed in service in the deduction year
- 5-year property bonus depreciation: $160,000 × 100% = $160,000
- 15-year property bonus depreciation: $80,000 × 100% = $80,000
- Regular depreciation on remaining 5-year: $0 (fully expensed)
- Regular depreciation on remaining 15-year: $0 (fully expensed)
- Regular 27.5-year depreciation: $560,000 ÷ 27.5 = $20,364
- **Total Year-One Depreciation: $260,364**
- Tax savings at 30% rate: $78,109
- **Additional value from cost segregation plus 100% bonus: $69,382**
...
1. **Documentation First:** Reimbursement packs, Augusta agendas/minutes + FMV comps, itemized furnishing lists—these create both tax benefits and audit protection.

2. **Six-Month Runway:** No new property acquisition or major capital deployment until six months of operating expenses are secured in reserves.

3. **DSCR Discipline:** Any property acquisition must show DSCR ≥ 1.25 at realistic ADR/occupancy assumptions—not optimistic projections.

4. **Quarterly KPIs + Tax Projections:** Regular review with professional advisors ensures strategies remain on track and adjustments are made promptly.

5. **Automatic BTC Stacking:** Custody upgrades happen on schedule; alt exposure minimized through systematic migration policy.
...
Cost segregation accelerates depreciation by reclassifying property components into shorter depreciation schedules. Instead of 27.5-year straight-line depreciation on the entire structure, a cost segregation study identifies 5-year personal property (appliances, fixtures) and 15-year land improvements (parking, landscaping). With 100% bonus depreciation for property acquired after January 19, 2025, a $500K-$1M building basis with 20-30% reclassification generates $100K-$300K in first-year bonus depreciation deductions. At 28-37% tax rates, this creates $28K-$111K in tax savings—amplified by the strategic timing of the cost segregation study. Binding contracts dated on or before January 19, 2025 stay on the old 20% 2026 phase-down.
