...
slug: frances-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/frances-wealth-plan
seo:
  primaryKeyword: pre retirement wealth optimization
  secondaryKeywords:
    - retirement income transition
    - pre retirement tax planning
  longTailKeywords:
    - how to optimize finances 10 years before retirement
...
tags:
  ...
  - tax optimization
  - healthcare planning
image: /assets/images/blog/wealth-plan-frances.jpg
imageAlt: "Frances' Personalized Wealth Plan Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, pre retirement optimization, retirement income, tax efficient withdrawals, healthcare planning, income transition
statistics:
    ...
    - label: "Retirement Accounts"
      value: "$500K+"
      icon: "dollar-sign"
    - label: "Tax Bracket Goal"
      value: "Optimize"
      icon: "percent"
    - label: "Healthcare Strategy"
      value: "Bridge to Medicare"
      icon: "heart"
    - label: "Income Target"
      value: "80% Replacement"
      icon: "trending-up"
faq:
  - question: "How should I optimize taxes in the years before retirement?"
    answer: "Pre-retirement tax optimization includes: maximizing catch-up contributions ($30,500 total 401k at 50+), Roth conversions in lower-income years, tax-loss harvesting in brokerage accounts, bunching charitable contributions, and evaluating whether to accelerate or defer income based on future tax brackets. The goal is smoothing tax rates across your lifetime."
  - question: "What is the best withdrawal strategy for retirement accounts?"
    answer: "Optimal withdrawal sequencing: First, taxable brokerage accounts (lower capital gains rates); second, traditional retirement accounts (manage tax brackets); third, Roth accounts (tax-free, let grow longest). Consider Roth conversions in low-income years between retirement and RMDs (age 73+). Coordinate with Social Security timing—delaying benefits to age 70 maximizes monthly payments."
  - question: "How do I handle healthcare before Medicare at 65?"
    answer: "Bridge healthcare strategies: COBRA continuation (18 months, expensive but comprehensive), ACA marketplace subsidies (if income managed below 400% FPL), private health insurance, spouse's employer plan if applicable, or part-time work with benefits. Health Savings Account (HSA) funds can pay for premiums during unemployment but not for COBRA or ACA premiums. Build HSA reserves before retirement for tax-free medical expenses."
  - question: "Should I pay off my mortgage before retirement?"
    answer: "Mathematically, keeping a low-rate mortgage (<4%) and investing the payoff amount usually wins. However, psychological benefits of being debt-free are significant. Consider: interest rate vs. expected investment returns, cash flow needs (eliminating payment reduces monthly needs), tax bracket (mortgage interest less valuable in lower brackets), and peace of mind. Hybrid approach: pay down aggressively in final working years but don't drain retirement accounts to eliminate."
  - question: "How do I create retirement income from my portfolio?"
...
Years between retirement (employment income ends) and age 73 (RMDs begin) offer potential for Roth conversions at lower tax rates.
...
**Retirement Timing**: Often 62-64
**Gap**: 1-3 years of healthcare coverage needed
