...
slug: abigail-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/abigail-wealth-plan
seo:
  primaryKeyword: eliminate w2 tax liability
  secondaryKeywords:
    - cost segregation strategy
    - early retirement planning
  longTailKeywords:
    - how to eliminate federal income tax on w2 income
    - wealth plan for early retirement before 59
...
tags:
  ...
  - early retirement
image: /assets/images/blog/wealth-plan-abigail.jpg
imageAlt: "Abigail's Personalized Wealth Plan Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, tax elimination, cost segregation, short term rental, s-corp strategy, bitcoin accumulation, early retirement, financial independence, w2 tax strategy
statistics:
    - label: "Annual W-2 Income"
      value: "$160,992"
      icon: "briefcase"
    - label: "Year 1 Tax Refund from STR"
      value: "$52,500"
      icon: "receipt"
    - label: "Total Retirement Assets"
      value: "$1.29M"
      icon: "piggy-bank"
    - label: "12-Month Projected ROI"
      value: "$108,600"
      icon: "trending-up"
    - label: "S-Corp Annual Tax Deferral"
      value: "$35,000"
      icon: "shield"
    - label: "Financial Independence Target"
      ...
      icon: "target"
faq:
  - question: "How can cost segregation on a short-term rental eliminate W-2 tax liability?"
  ...
  - question: "What is the Augusta Rule and how does it save $7,000+ annually?"
    answer: "The Augusta Rule (IRC Section 280A) allows homeowners to rent their primary residence to their own business for up to 14 days per year, completely tax-free. At $500/day fair market rate, this moves $7,000 from taxable business income to tax-free personal income while maintaining full mortgage deductions."
  - question: "How does a Roth conversion ladder enable penalty-free early retirement?"
    answer: "A Roth conversion ladder converts traditional 401(k) funds to Roth annually, matching conversions to depreciation losses for zero-tax conversions. After 5 years, each conversion tranche becomes accessible penalty-free. Starting in 2025, Abigail's first conversions become available in 2029, creating a penalty-free income stream before age 59½."
  - question: "What makes Bitcoin accumulation a primary wealth strategy in this plan?"
    answer: "With $12,000+ annual capacity for alternative investments and existing crypto exposure, systematic Bitcoin dollar-cost averaging (30% of free cash flow) compounds over time. The plan targets moving 50% of retirement assets to Bitcoin while maintaining MSTY ETF for monthly yield, creating uncapped upside potential with income stability."
  - question: "How does hiring children through an S-Corp create $14,600 tax-free income per child?"
    answer: "Children under 18 employed by a parent's S-Corp can earn up to $14,600 (2025 standard deduction) completely federal income tax-free. The S-Corp deducts wages as a business expense, and children can contribute to Roth IRAs, jumpstarting tax-free retirement savings while reducing household tax burden."
  - question: "What is a Section 475(f) election and why file it by March 2026?"
    answer: "The Section 475(f) mark-to-market election converts capital gains/losses from trading into ordinary income/losses, enabling trading losses to offset W-2 income directly. Filed with the 2025 tax return by March 15, 2026, it creates a new deduction bucket that can shelter $30,000+ in income while maintaining full Solo 401(k) contribution capacity."
---
...
For a **$500,000-$600,000 short-term rental property**, a comprehensive cost segregation study typically identifies 20-30% of the property's value as eligible for accelerated depreciation. This means **$100,000-$180,000 in first-year write-offs** through a combination of 100% bonus depreciation (for property acquired after January 19, 2025) and accelerated schedules.
...
1. **Personal involvement in operations** — not just passive investment
2. **Active decision-making** on pricing, guest management, and improvements
3. **Time tracking** via Google Sheet or app to document participation hours
4. **Operational oversight** rather than pure third-party management
...
1. **Form Trading LLC in 2025** — separate entity from property LLCs
2. **Transfer active positions** to LLC brokerage account
3. **File Section 475(f) election** by March 15, 2026
4. **Open Solo 401(k)** with $69,000 annual contribution capacity ($23,000 employee + $46,000 employer)
5. **Implement systematic trading** with ordinary loss protection
...
1. **Self-employment tax savings**: Only "reasonable salary" is subject to Social Security/Medicare taxes; distributions are exempt
2. **Business deduction expansion**: Health insurance, HSA contributions, and Section 179 deductions become available
...
1. **S-Corp adopts QSEHRA plan** with written documentation
2. **Employees (Abigail and spouse) incur medical expenses** — premiums, deductibles, copays, dental, vision
3. **Submit receipts monthly** to the company
4. **Company reimburses through payroll** — 100% tax-free to employee, 100% deductible to business
...
**Execution framework:**
1. **Document fair market rental rate** — pull 3 comparable short-term rental listings
2. **Corporate minutes approval** — formal authorization of meeting/event rental
3. **Invoice the S-Corp** — proper documentation of business purpose
4. **14 days at $500/day = $7,000 tax-free income**
...
1. **Convert traditional 401(k)/IRA to Roth IRA** — pay ordinary income tax on conversion amount
2. **Wait 5 years** from January 1 of the conversion year
3. **Withdraw converted principal penalty-free** — regardless of age
4. **Repeat annually** to create rolling access ladder
