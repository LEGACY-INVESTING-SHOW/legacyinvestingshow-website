...
slug: andreea-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/andreea-wealth-plan
seo:
  primaryKeyword: high income tax optimization
  secondaryKeywords:
    - severance year tax strategy
    - cost segregation bonus depreciation
  longTailKeywords:
    - how to reduce taxes in high income year
...
tags:
  ...
  - aggressive planning
  - asset acquisition
image: /assets/images/blog/wealth-plan-andreea.jpg
imageAlt: "Andreea's High-Income Severance Year Tax Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, high income tax strategy, severance year planning, cost segregation, bonus depreciation, aggressive tax optimization, asset acquisition decision, andreea wealth plan
statistics:
    - label: "Severance Year Income"
      value: "$770,000"
      icon: "dollar-sign"
    ...
    - label: "Strategy Focus"
      value: "Cost Seg + Depreciation"
      icon: "shield"
    - label: "Decision Point"
      value: "STR vs Equipment"
      icon: "git-branch"
faq:
  - question: "How does a $770,000 severance year create unique tax planning urgency?"
  ...
  - question: "How can cost segregation generate $131,860 to $398,280 in year-one value?"
    answer: "These figures represent the combined impact of multiple strategies at high tax rates. Path A calculation: (1) Cost segregation on $500K-$800K property creates $100K-$200K in accelerated depreciation, (2) 100% bonus depreciation (qualified property acquired after January 19, 2025) on that short-life basis adds $100K-$200K, (3) STR operational losses (startup costs, first-year operations) add $15K-$30K, (4) Augusta Rule utilization adds $2K-$3K, (5) Other deductions (vehicle, home office, etc.) add $5K-$10K. Total deductions: $222K-$443K. At 37% federal + state + NIIT (potentially 45%+ combined), this creates $100K-$200K in federal tax savings alone. The $131K-$398K range includes federal, state, and potential NIIT savings across conservative to aggressive scenarios with different property values and deduction capture rates."
  - question: "What is the 100% bonus depreciation focus and how does it apply to 2025?"
    answer: "Bonus depreciation allows immediate expensing of qualified property in the year placed in service. The 2025 tax law restored 100% bonus depreciation for qualified property acquired after January 19, 2025 (Section 168(k)). Property under a written binding contract on or before that date stays on the old phase-down and gets 20% in 2026. On $200K of 5-year property identified through cost segregation and acquired after January 19, 2025, 100% bonus = $200K immediate deduction. Combined with Section 179 (separate limit), strategic asset purchases in a $770K income year can generate $200K-$400K in total first-year deductions."
...
- Bonus depreciation (100% after January 19, 2025): $80,000
...
- Bonus depreciation (100% after January 19, 2025): $200,000
...
**Provider Selection (Immediate Priority):**
Given October timing, Andreea needs a cost segregation provider who can:
...
**ROI on Study Cost:**
Even at $10,000 study cost for an $800,000 property, the tax savings from accelerated depreciation typically exceed $50,000 — a 500%+ return on the study investment.
...
- 5-year property remaining: $0
- 15-year property remaining: $0
...
**The Problem:**
Andreea's $770,000 income far exceeds Roth IRA direct contribution limits:
...
If Andreea has existing pre-tax Traditional/SEP/SIMPLE IRA balances, conversion triggers tax on proportional amount.
...
**Risk**: Property not placed in service by year-end, losing 2025 depreciation
**Mitigation**:
...
**Risk**: $200,000+ capital deployment in concentrated strategy
**Mitigation**:
...
**Risk**: IRS challenges cost segregation or material participation
**Mitigation**:
...
**Risk**: Severance classification affects earned income availability for retirement contributions
**Mitigation**:
...
Path A involves acquiring a short-term rental property and executing a [cost segregation study](/tax-strategies/cost-segregation) to accelerate depreciation. A $500K property with cost segregation might generate $100K-$150K in year-one deductions (including [bonus depreciation](/tax-strategies/bonus-depreciation)). The equipment-heavy alternative involves purchasing business equipment (Section 179 eligible) to create immediate deductions. Equipment purchases depreciate faster (often 100% in year one via Section 179) but don't build equity or generate ongoing income. Path A creates both tax deductions AND cash-flowing assets; equipment purchases create deductions but limited ongoing value. The decision depends on: capital available, time for property acquisition, operational capacity for STR management, and long-term wealth goals.

### How can cost segregation generate $131,860 to $398,280 in year-one value?

These figures represent the combined impact of multiple strategies at high tax rates. Path A calculation: (1) Cost segregation on $500K-$800K property creates $100K-$200K in accelerated depreciation, (2) 100% [bonus depreciation](/tax-strategies/bonus-depreciation) (qualified property acquired after January 19, 2025) on that short-life basis adds $100K-$200K, (3) STR operational losses (startup costs, first-year operations) add $15K-$30K, (4) [Augusta Rule](/tax-strategies/augusta-rule) utilization adds $2K-$3K, (5) Other deductions (vehicle, home office, etc.) add $5K-$10K. Total deductions: $222K-$443K. At 37% federal + state + NIIT (potentially 45%+ combined), this creates $100K-$200K in federal tax savings alone. The $131K-$398K range includes federal, state, and potential NIIT savings across conservative to aggressive scenarios with different property values and deduction capture rates.

### What is the 100% bonus depreciation focus and how does it apply to 2025?

Bonus depreciation allows immediate expensing of qualified property in the year placed in service. The 2025 tax law restored 100% bonus depreciation for qualified property acquired after January 19, 2025 (Section 168(k)). Property under a written binding contract on or before that date stays on the old phase-down and gets 20% in 2026. On $200K of 5-year property identified through cost segregation and acquired after January 19, 2025, 100% bonus = $200K immediate deduction. Combined with Section 179 (separate limit), strategic asset purchases in a $770K income year can generate $200K-$400K in total first-year deductions.
