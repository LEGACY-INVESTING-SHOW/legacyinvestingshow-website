...
slug: abel-wealth-plan
canonical: https://www.legacyinvestingshow.com/blog/abel-wealth-plan
seo:
  primaryKeyword: real estate professional status
  secondaryKeywords:
    - passive loss deduction
    - multi property portfolio
  longTailKeywords:
    - how to qualify as real estate professional
    - real estate professional 750 hour test
...
tags:
  ...
  - tax optimization
  - cost segregation
image: /assets/images/blog/wealth-plan-abel.jpg
imageAlt: "Abel's Personalized Wealth Plan Strategy - Legacy Investing Show"
imageWidth: 1200
imageHeight: 630
...
disclaimer: true
keywords:
  - wealth plan, real estate professional status, REP qualification, passive loss deduction, cost segregation, property portfolio
statistics:
    - label: "REP Hour Target"
      value: "750+ hrs/year"
      icon: "clock"
    - label: "Passive Loss Potential"
      value: "$50,000+"
      icon: "dollar-sign"
    - label: "Cost Seg Benefit"
      value: "$80,000+"
      icon: "home"
...
faq:
  ...
  - question: "How does cost segregation work with REP status?"
    answer: "Cost segregation studies identify components of a property that can be depreciated faster (5, 7, or 15 years vs. 27.5 years). With REP status, these accelerated depreciation deductions create passive losses that can offset W-2 or active business income. On a $400,000 property, cost segregation might identify $80,000 in 5-year property, creating $80,000 in first-year deductions worth $20,000+ in tax savings at 24% bracket."
  - question: "Can my spouse qualify as the REP if I have a full-time job?"
    answer: "Yes, if your spouse meets the 750-hour test and the material participation requirements, they can qualify as the Real Estate Professional for your jointly-owned properties. This allows passive losses to offset your W-2 income on your joint tax return. This is a common strategy for households with one spouse working full-time and the other managing real estate."
  - question: "What documentation does the IRS require for REP status?"
    answer: "The IRS requires contemporaneous time logs showing: dates, hours spent, specific activities performed, and property address. Use apps like Toggl, Clockify, or calendar entries. Keep receipts for all property-related expenses. Maintain a summary report categorizing hours by activity type. If audited, you must prove you met both the 750-hour test and material participation requirements in advance (cannot retroactively qualify)."
---
...
1. **750+ Hours Annually**: More than 750 hours in real property trades or businesses
2. **More Than Half Time**: Hours in real estate must exceed hours in all other professions combined
3. **Material Participation**: Must materially participate in each rental property (or elect to aggregate)
...
1. **500-Hour Test**: Work 500+ hours in the activity
2. **Substantially All Participation**: Do substantially all the work
3. **100-Hour Test**: 100+ hours AND no one else works more
4. **Significant Participation Activity**: 100+ hours in multiple activities (aggregate 500+)
5. **Prior Year Participation**: Materially participated in 5 of prior 10 years
6. **Personal Service Activity**: Materially participated in any 3 prior years (for personal services)
...
**Additional Year 1 Deduction**: $105,455
**Tax Savings at 24% bracket**: $25,309
**Tax Savings at 35% bracket**: $36,909
...
**Quarter 1**: Property #4 acquisition and integration
**Quarter 2**: Property #5 acquisition, portfolio optimization
**Quarter 3**: Evaluate management team needs, consider property manager
**Quarter 4**: 1031 exchange evaluation for portfolio optimization
...
1. **750 Hours Requires Intentionality**: REP status doesn't happen accidentally; it requires dedicated time allocation and documentation
2. **Cost Segregation Multiplies Benefits**: REP status without cost segregation is leaving money on the table
3. **Scale Enables Qualification**: 3-5 properties creates the hour base needed while providing diversification
4. **Contemporaneous Documentation is Critical**: You cannot retroactively qualify; records must be kept in real-time
5. **Professional Guidance Essential**: REP qualification and cost segregation require CPA expertise
